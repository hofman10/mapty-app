...
class App {
  ...
  _getPosition() {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        ...
        function () {
          alert("Ne mogu da pronadjem vasu trenutnu lokaciju");
        },
      );
    }
  }
  ...
  _newWorkout(e) {
    ...
    if (type === "running") {
      ...
      if (
        ...
        return alert("Ispis u iputima mora da bude pozitivan broj!!!");
  ...
  _moveToPopup(e) {
    ...
    let workout = this.#workouts.find((workout) => {
